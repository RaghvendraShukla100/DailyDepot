    ...
    <>
      ...
      <div className="flex border-gray-400">
        ...
        <div className="w-[20%]">
          ...
          <div>
            {!showBrandSearch ? (
              <div className="border-t border-r border-gray-300 uppercase font-bold flex items-center justify-between px-5 py-3 text-[12px]">
                <span>brand</span>
                <span
              ...
              <div className="relative border-t  border-r  border-gray-300 px-5 pb-2 text-sm">
                <input
                  type="text"
          ...
          {/* ✅ Price Filter */}
          <div className="border-t border-r border-gray-300 uppercase font-bold px-5 py-3 text-[12px]">
            Price
          </div>
          ...
          <div>
            {!showColorSearch ? (
              <div
                className="border-t border-r border-gray-300 uppercase font-bold flex items-center 
          ...
          <div>
            ...
            <div className="px-5 border-r mb-5 border-gray-300">
        ...
        {/* Products Section */}
        <div className="box-border w-[80%]">PRODUCT</div>
      </div>
    </>
  );
}
